...
export function october(worker: Worker) {
    ...
    const LEVELS: Level[] = [
        ...
        {
            pieces: [
                {piece: 'bean', position: {x: 0, y: 2}},
                {piece: 'frog', position: {x: 2, y: 2}},
                {piece: 'frog', position: {x: 2, y: 3}},
                {piece: 'frog', position: {x: 3, y: 1}},
                {piece: 'king', position: {x: 0, y: 0}},
            ],
            boardSize: {x: 4, y: 4},
            moves: 2,
            text: 'Frogs can only jump over each other.',
            walls: [],
        },
        // 14 (🫘🐸)
        {
            pieces: [
                {piece: 'bean', position: {x: 2, y: 4}},
                {piece: 'frog', position: {x: 0, y: 0}},
                {piece: 'frog', position: {x: 1, y: 0}},
                {piece: 'frog', position: {x: 2, y: 1}},
                {piece: 'king', position: {x: 0, y: 5}},
                {piece: 'rook', position: {x: 5, y: 0}},
            ],
            boardSize: {x: 6, y: 6},
            moves: 5,
            text: '',
        ...
        {
            pieces: [
                {piece: 'bishop', position: {x: 0, y: 0}},
                {piece: 'can', position: {x: 3, y: 3}},
                {piece: 'frog', position: {x: 3, y: 0}},
                {piece: 'frog', position: {x: 3, y: 1}},
                {piece: 'frog', position: {x: 3, y: 2}},
                {piece: 'frog', position: {x: 4, y: 0}},
                {piece: 'frog', position: {x: 4, y: 1}},
                {piece: 'frog', position: {x: 4, y: 2}},
                {piece: 'king', position: {x: 0, y: 1}},
            ],
            boardSize: {x: 5, y: 4},
            moves: 5,
            text: '',
        ...
        // 16 (🫘👟⚽🧲)
        {
            pieces: [
                {piece: 'ball', position: {x: 2, y: 3}},
                {piece: 'ball', position: {x: 3, y: 3}},
                {piece: 'bean', position: {x: 3, y: 1}},
                {piece: 'king', position: {x: 0, y: 0}},
                {piece: 'magnet', position: {x: 2, y: 1}},
                {piece: 'queen', position: {x: 0, y: 3}},
                {piece: 'shoe', position: {x: 3, y: 0}},
            ],
            boardSize: {x: 4, y: 4},
            moves: 3,
            text: 'Any piece can chose to move next to a magnet.',
            walls: [
                {x: 0, y: 1},
                {x: 0, y: 2},
                {x: 1, y: 1},
        ...
        // 17 (🫘🧲🔋)
        {
            pieces: [
                {piece: 'king', position: {x: 0, y: 0}},
                {piece: 'magnet', position: {x: 1, y: 2}},
                {piece: 'frog', position: {x: 0, y: 2}},
                {piece: 'frog', position: {x: 2, y: 2}},
                {piece: 'bean', position: {x: 2, y: 0}},
                {piece: 'chargedBattery', position: {x: 2, y: 1}},
            ],
            boardSize: {x: 3, y: 4},
            moves: 2,
            text: '',
        ...
        {
            pieces: [
                {piece: 'bomb', position: {x: 5, y: 0}},
                {piece: 'can', position: {x: 6, y: 1}},
                {piece: 'king', position: {x: 3, y: 3}},
                {piece: 'magnet', position: {x: 0, y: 0}},
                {piece: 'magnet', position: {x: 6, y: 6}},
            ],
            boardSize: {x: 8, y: 7},
            moves: 6,
            text: '',
